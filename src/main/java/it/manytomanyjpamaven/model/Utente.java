...
public class Utente {
	...
	@Override
	public int hashCode() {
		return Objects.hash(cognome, dateCreated, id, nome, password, stato, username);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(cognome, other.cognome) && Objects.equals(dateCreated, other.dateCreated)
				&& Objects.equals(id, other.id) && Objects.equals(nome, other.nome)
				&& Objects.equals(password, other.password) && stato == other.stato
